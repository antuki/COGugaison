...
exemple_popcom_deforme <- exemple_popcom %>% 
  add_row(CODGEO = c(rep("01001",5),"14666","75101",NA,"98756","ZZZZZ"))
```
...
[1] "# Dans la mesure où le COG n'est pas identifiable, le diagnostic de COG correspond au COG le plus récent d'apparition de chaque code commune du fichier en entrée."
...
Toutefois, lorsque le COG est relativement ancien, comme ici 2014, il n'est pas évident à partir de cela d'en déduire qu'il s'agit d'une table millésimée 2014 avec simplement quelques lignes erronées dedans puisque `diag_COG` identifie en priorité les COG récents. Dans ce cas, la fonction `COG_akinator` vue précédemment peut vous aider à identifier le millésime 2014 de par son approche complémentaire à `diag_COG` :
